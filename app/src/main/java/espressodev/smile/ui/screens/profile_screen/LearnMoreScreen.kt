...
import espressodev.smile.util.Constants.GITHUB_DESC
import espressodev.smile.util.Constants.GITHUB_LINK
import espressodev.smile.util.Constants.HIGH_PADDING
import espressodev.smile.util.Constants.MEDIUM_PADDING
import espressodev.smile.util.Constants.PRIVACY_POLICY
import espressodev.smile.util.Constants.PRIVACY_POLICY_LINK
import espressodev.smile.util.Constants.PRIVACY_TERM_CONDITIONS
import espressodev.smile.util.Constants.SMALL_ICON_SIZE
import espressodev.smile.util.Constants.TERMS_CONDITIONS
import espressodev.smile.util.Constants.TERMS_CONDITIONS_LINK
