...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: agp (8.2.0-alpha16)
            ...
            /**
             * Returns the version associated to this alias: gradle (8.2.0-alpha16)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
         ...
         */
        public SquareupVersionAccessors getSquareup() {
            return vaccForSquareupVersionAccessors;
        }
    ...
    public static class AccompanistVersionAccessors extends VersionFactory  {
        ...
        public AccompanistVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: accompanist.systemuicontroller (0.30.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        private final FirebaseAnalyticsVersionAccessors vaccForFirebaseAnalyticsVersionAccessors = new FirebaseAnalyticsVersionAccessors(providers, config);
        ...
        private final FirebaseDatabaseVersionAccessors vaccForFirebaseDatabaseVersionAccessors = new FirebaseDatabaseVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.firebase.analytics
         */
        public FirebaseAnalyticsVersionAccessors getAnalytics() {
            return vaccForFirebaseAnalyticsVersionAccessors;
        }

        /**
         * Returns the group of versions at versions.firebase.auth
         */
        ...
        /**
         * Returns the group of versions at versions.firebase.database
         */
        public FirebaseDatabaseVersionAccessors getDatabase() {
            return vaccForFirebaseDatabaseVersionAccessors;
        }

        /**
         * Returns the group of versions at versions.firebase.firestore
         */
    ...
    public static class FirebaseAnalyticsVersionAccessors extends VersionFactory  {

        public FirebaseAnalyticsVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: firebase.analytics.ktx (21.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtx() { return getVersion("firebase.analytics.ktx"); }

    }

    public static class FirebaseAuthVersionAccessors extends VersionFactory  {

        public FirebaseAuthVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: firebase.auth.ktx (22.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebaseCrashlyticsVersionAccessors extends VersionFactory  {
        ...
        public FirebaseCrashlyticsVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: firebase.crashlytics.gradle (2.9.8)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: firebase.crashlytics.ktx (18.4.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtx() { return getVersion("firebase.crashlytics.ktx"); }

    }

    public static class FirebaseDatabaseVersionAccessors extends VersionFactory  {

        public FirebaseDatabaseVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: firebase.database.ktx (20.2.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtx() { return getVersion("firebase.database.ktx"); }
    ...
    public static class FirebaseFirestoreVersionAccessors extends VersionFactory  {
        ...
        public FirebaseFirestoreVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: firebase.firestore.ktx (24.7.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebaseMessagingVersionAccessors extends VersionFactory  {
        ...
        public FirebaseMessagingVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: firebase.messaging.ktx (23.2.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtx() { return getVersion("firebase.messaging.ktx"); }
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        public GoogleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: google.services (4.3.15)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class HiltAndroidVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("hilt.android"); }
            ...
            /**
             * Returns the version associated to this alias: hilt.android.compiler (2.47)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class HiltNavigationVersionAccessors extends VersionFactory  {
        ...
        public HiltNavigationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: hilt.navigation.fragment (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getFragment() { return getVersion("hilt.navigation.fragment"); }
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        public NavigationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: navigation.compose (2.7.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
